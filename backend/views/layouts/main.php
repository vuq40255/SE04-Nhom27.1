...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo Yii::$app->homeUrl . "enterprise" ?>"> Doanh Nghiệp</a>
            </li>
            <hr class="sidebar-divider my-0">
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo Yii::$app->homeUrl . "student" ?>"> Sinh Viên</a>
            </li>
            <hr class="sidebar-divider my-0">
            <li class="nav-item">
